...
model.fit(train_images, train_labels, batch_size=200,  epochs=1500, validation_data=(validation_images,validation_labels), steps_per_epoch = 4, validation_steps=1,
